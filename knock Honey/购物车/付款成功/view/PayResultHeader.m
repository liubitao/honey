...
- (instancetype)initWithFrame:(CGRect)frame model:(KHPayResultModel *)model;{
    ...
    if (self) {
        ...
        [sucButton setImage:IMAGE_NAMED(@"paySuccess") forState:UIControlStateNormal];
