...
- (void)setEditing:(BOOL)editting animated:(BOOL)animated {
    ...
    if (editting){
        ...
        if (m_checkImageView == nil) {
            m_checkImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"cartnoSelected"]];
...
- (void)setChecked:(BOOL)checked {
    if (checked) {
        m_checkImageView.image = [UIImage imageNamed:@"cartSelected"];
        self.backgroundView.backgroundColor = [UIColor whiteColor];
    } else {
        m_checkImageView.image = [UIImage imageNamed:@"cartnoSelected"];
        self.backgroundView.backgroundColor = [UIColor whiteColor];
    }
    m_checked = checked;
}
