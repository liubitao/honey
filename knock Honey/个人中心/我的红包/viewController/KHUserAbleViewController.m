...
#import "BonusModel.h"
#import "BonusCell.h"
@interface KHUserAbleViewController ()<UITableViewDataSource,UITableViewDelegate,DZNEmptyDataSetDelegate,DZNEmptyDataSetSource>
@property (nonatomic,strong) UITableView *tableView;
@property (nonatomic,strong) NSMutableArray *dataArray;

@end

@implementation KHUserAbleViewController
...
- (void)getData{
    ...
    [YWHttptool GET:PortCoupon_list parameters:parameter success:^(id responseObject) {
        ...
        self.dataArray = [BonusModel mj_objectArrayWithKeyValuesArray:responseObject[@"result"][@"can_use"]];
