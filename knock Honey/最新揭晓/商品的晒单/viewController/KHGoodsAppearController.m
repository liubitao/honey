...
@interface KHGoodsAppearController ()<UITableViewDataSource,UITableViewDelegate,DZNEmptyDataSetDelegate,DZNEmptyDataSetSource>{
...
@implementation KHGoodsAppearController
